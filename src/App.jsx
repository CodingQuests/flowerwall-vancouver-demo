...
export default function App() {
  ...
  const [activePackage, setActivePackage] = useState(2); // Signature is default
    ...
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <div className="w-full bg-gradient-to-r from-rose-200/70 via-pink-200/60 to-rose-200/70 text-zinc-800 text-sm overflow-hidden relative">
        <div className="mx-auto max-w-6xl px-4 py-2 flex items-center justify-between relative z-10">
          ...
          <div className="flex items-center gap-5">
            <a href="#" className="hover:text-rose-600 transition-all duration-300 hover:scale-110 inline-block">Instagram</a>
            <a href="#" className="hover:text-rose-600 transition-all duration-300 hover:scale-110 inline-block">TikTok</a>
            <a href="#" className="hover:text-rose-600 transition-all duration-300 hover:scale-110 inline-block">Pinterest</a>
          </div>
        </div>
      </div>
      ...
      <header className={`sticky top-0 z-40 backdrop-blur-md border-b transition-all duration-300 ${
        ...
        <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm text-zinc-700">
            {['Packages', 'Use Cases', 'Portfolio', 'How It Works', 'Service Areas'].map((item, idx) => (
              <a 
                key={idx}
                href={`#${item.toLowerCase().replace(/ /g, '')}`}
                className="relative group"
              >
                <span className="hover:text-zinc-950 transition-colors">{item}</span>
          ...
          <div className="mx-auto max-w-6xl px-4 pb-10 w-full">
            <div className="max-w-2xl rounded-2xl bg-white/90 backdrop-blur-sm p-6 shadow-xl">
              ...
              <div className="mt-4 flex flex-wrap items-center gap-3 text-xs text-zinc-700">
                {['On-Time or $50 Credit', 'Fully Installed', 'Licensed & Insured'].map((text, idx) => (
      ...
      <section className="border-b bg-gradient-to-r from-white via-rose-50/30 to-white">
        <div className="mx-auto max-w-6xl px-4 py-4 grid grid-cols-2 md:grid-cols-4 items-center gap-4 text-sm">
          ...
          <div className="text-zinc-900 hover:text-rose-600 transition-colors cursor-default">Fairmont • Paradox • JW Marriott</div>
          <div className="text-zinc-900 hover:text-rose-600 transition-colors cursor-default">On-time guarantee</div>
          <div className="text-zinc-900 hover:text-rose-600 transition-colors cursor-default">Serving GVA & Fraser Valley</div>
        </div>
      </section>
      ...
      <section id="packages" className="mx-auto max-w-6xl px-4 py-12">
        <div className="flex items-end justify-between gap-4">
          ...
          <a href="#quote" className="text-rose-700 hover:text-rose-800 hover:gap-2 text-sm hidden md:flex items-center gap-1 transition-all group">
        ...
        <div id="packages-grid" className="mt-6 grid gap-5">
          {packages.map((p, i) => (
            <div
              key={i}
              ...
              className={`relative rounded-2xl border-2 p-6 shadow-lg transition-all duration-300 cursor-pointer ${
                activePackage === i
                  ...
                  : p.popular
                  ? "border-rose-400 hover:border-rose-600 hover:shadow-xl hover:-translate-y-1"
                  : "border-zinc-200 hover:border-rose-300 hover:shadow-xl hover:-translate-y-1"
              }`}
            >
              {p.popular && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-rose-600 to-pink-600 text-white px-4 py-1 rounded-full text-xs font-bold shadow-lg">
                  MOST POPULAR
                </div>
              )}
        ...
        <div className="mx-auto max-w-6xl px-4 py-12">
          ...
          <div className="mt-8 grid grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              { title: "Hotels & Lobbies", img: GALLERY[3], icon: "🏨", color: "purple" },
            ].map((c, i) => (
              <a
                key={i}
                href="#quote"
              ...
              >
                ...
                <div className="p-4">
                  <div className="font-semibold text-lg text-zinc-900 group-hover:text-rose-600 transition-colors">{c.title}</div>
      ...
      <section id="quote" className="mx-auto max-w-6xl px-4 py-12">
        <div className="rounded-3xl border-2 border-rose-200 bg-gradient-to-br from-rose-50 via-white to-pink-50 p-8 shadow-xl hover:shadow-2xl transition-all duration-300">
          <div className="text-center mb-6">
            <h3 className="text-2xl md:text-3xl font-serif text-zinc-900">Get Your Instant Quote</h3>
      ...
      <section id="portfolio" className="mx-auto max-w-6xl px-4 py-12">
        ...
        <p className="mt-1 text-zinc-600">See what we've created for our clients</p>
      ...
      {/* How It Works */}
      <section id="howitworks" className="bg-gradient-to-b from-zinc-50 to-white border-y">
        <div className="mx-auto max-w-6xl px-4 py-12">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="group rounded-2xl border-2 border-zinc-200 bg-white p-6 hover:border-rose-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <div className="font-semibold text-lg text-zinc-900 group-hover:text-rose-600 transition-colors">{s.title}</div>
      ...
      <footer id="serviceareas" className="mx-auto max-w-6xl px-4 py-12">
        <div className="rounded-3xl bg-gradient-to-br from-rose-100 via-pink-50 to-rose-100 p-8 shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-rose-200">
          <div className="font-semibold text-lg text-zinc-900">Service Areas</div>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-zinc-700">
          <div className="group">
            <div className="font-semibold text-lg text-zinc-900 group-hover:text-rose-600 transition-colors">Flowerwall Vancouver</div>
            <p className="mt-2 text-sm">
              Beautiful backdrops for events of all sizes. Fully installed, on time, every time.
            </p>
          </div>
          <div className="group">
            <div className="font-semibold text-lg text-zinc-900 group-hover:text-rose-600 transition-colors">Contact</div>
            <p className="mt-2 text-sm">
              <a href="mailto:info@flowerwallvancouver.com" className="hover:text-rose-600 transition-colors">info@flowerwallvancouver.com</a>
              <br />
              <a href="tel:+16045550199" className="hover:text-rose-600 transition-colors">+1 (604) 555-0199</a>
            </p>
          </div>
          <div className="group">
            <div className="font-semibold text-lg text-zinc-900 group-hover:text-rose-600 transition-colors">Follow Us</div>
